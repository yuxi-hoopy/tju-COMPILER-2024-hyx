...
FSM CREATE_NFA() {
    ...
    NFA.addNode(new FSM_Node(8, TokenCode::UNDIFNIE, false));   // 过渡节点（0/num.）
    NFA.addNode(new FSM_Node(9, TokenCode::UNDIFNIE, false));   // 过渡节点（num）
    ...
    NFA.addTrans(8, 7, numList);   // 添加从节点 7 到节点 8 的转移，允许处理小数点后的数字部分
    NFA.addTrans(8, 9, numList);   // 添加从节点 8 到节点 9 的转移，允许处理小数点后的数字部分
    NFA.addTrans(8, 7, zeroList);   // 添加从节点 7 到节点 8 的转移，允许处理小数点后的数字部分
    NFA.addTrans(8, 9, zeroList);   // 添加从节点 8 到节点 9 的转移，允许处理小数点后的数字部分
